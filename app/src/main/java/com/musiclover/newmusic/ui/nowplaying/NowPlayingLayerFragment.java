package com.musiclover.newmusic.ui.nowplaying;
...
import com.musiclover.newmusic.loader.medialoader.SongLoader;
import com.musiclover.newmusic.service.MusicPlayerRemote;
import com.musiclover.newmusic.service.MusicServiceEventListener;
import com.musiclover.newmusic.ui.AppActivity;
import com.musiclover.newmusic.ui.CardLayerController;
import com.musiclover.newmusic.ui.MusicServiceActivity;
import com.musiclover.newmusic.ui.page.CardLayerFragment;

import com.musiclover.newmusic.model.Song;

import com.musiclover.newmusic.ui.bottomsheet.OptionBottomSheet;
import com.musiclover.newmusic.ui.widget.avsb.AudioVisualSeekBar;
import com.musiclover.newmusic.util.SortOrder;
import com.musiclover.newmusic.util.Tool;
...
/*        Handler handler = new Handler();
    ...
    void updatePlayPauseState() {
        if (MusicPlayerRemote.isPlaying()) {
            mButtonRight.setImageResource(R.drawable.ic_pause_circle);
            mPlayPauseButton.setImageResource(R.drawable.ic_pause_circle);
        } else {
            mButtonRight.setImageResource(R.drawable.ic_play_circle);
            mPlayPauseButton.setImageResource(R.drawable.ic_play_circle);
        }
    }
