package com.musiclover.newmusic.ui.widget.navigate;
...
import com.musiclover.newmusic.ui.widget.fragmentnavigationcontroller.NavigationControllerFragment;
...
//            mNavigationController.setPresentStyle(r.nextInt(39)+1); //exclude NONE present style
    ...
    private void initBackStack(Bundle savedInstanceState) {
        ...
        mNavigationController.setPresentStyle(NavigationFragment.PRESENT_STYLE_DEFAULT);
