package com.musiclover.newmusic.ui.page.librarypage.artist;
...
import com.musiclover.newmusic.contract.AbsBindAbleHolder;
import com.musiclover.newmusic.contract.AbsMediaAdapter;
import com.musiclover.newmusic.glide.ArtistGlideRequest;
import com.musiclover.newmusic.glide.GlideApp;
import com.musiclover.newmusic.helper.menu.MenuHelper;
import com.musiclover.newmusic.loader.medialoader.GenreLoader;
import com.musiclover.newmusic.model.Artist;
import com.musiclover.newmusic.model.Genre;
import com.musiclover.newmusic.ui.bottomsheet.OptionBottomSheet;
import com.musiclover.newmusic.util.PhonographColorUtil;
          ...
          /* String[] artists = artist.getName().replace(" ft ",",").replace(';',',').split("\\s*,\\s*");
           ...
           if(artists.length>1)
            ...
            ArtistGlideRequest.Builder.from(GlideApp.with(getContext()), artist)
                    ...
                    .build()
                    .centerCrop()
                    .error(R.drawable.music_headphone)
                    .listener(new RequestListener<Bitmap>() {
                        ...
                        public boolean onResourceReady(Bitmap resource, Object model, Target<Bitmap> target, DataSource dataSource, boolean isFirstResource) {
                            int color;
                            if (resource != null)
                                color = PhonographColorUtil.getColor(PhonographColorUtil.generatePalette(resource), mPanelColor.getResources().getColor(R.color.orange));
                            else color = mPanelColor.getResources().getColor(R.color.orange);
