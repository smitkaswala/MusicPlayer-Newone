package com.musiclover.newmusic.ui.widget;
...
import com.musiclover.newmusic.util.BitmapEditor;

import com.musiclover.newmusic.util.Tool;
import com.musiclover.newmusic.coordinate.MCoordinate;
...
public class ToggleButton extends View {
    ...
    boolean isSet = false;
    double gocDuong = 1;
    MCoordinate.MPoint p1 = new MCoordinate.MPoint(),p2 = new MCoordinate.MPoint(),p3 = new MCoordinate.MPoint();
    @Override
